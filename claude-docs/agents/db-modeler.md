...
- **Read** - Read schema files, specs, and existing migrations
- **Write** - Create new migration files
- **Edit** - Modify schema.prisma and seed.ts
- **Glob** - Find files by pattern
- **Grep** - Search code for patterns
- **Bash** - Run `prisma generate`, `prisma migrate dev` (database operations only)
...
- Any tools outside standard file and database operations
