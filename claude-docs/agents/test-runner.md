...
2. **Update test-runs.md**: Add entry to table in `claude-docs/reports/test-runs.md`
...
After each test run, add a row to the table in `claude-docs/reports/test-runs.md`:
...
Per `claude-docs/policies/testing.md`:
