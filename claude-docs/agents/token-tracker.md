...
**Session History**: `claude-docs/history/YYYY-MM-DD/session-XX.json` files
...
**Read**: `claude-docs/history/**`, `claude-docs/reports/**`, `claude-docs/agents/*.md`, git history

**Write**: `claude-docs/reports/token-tracking/**` (exclusive)

**Propose Only**: `claude-docs/agents/*.md`, `claude-docs/docs/policies/*.md`

---

## 4. Usage Reviews

Path: `claude-docs/reports/token-tracking/usage-review-YYYY-MM-DD-vNNN.md`
...
**Data source**: Check UAT reports in `claude-docs/reports/UAT/` for ua-tester sessions.
