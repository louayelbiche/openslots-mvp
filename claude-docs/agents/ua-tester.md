...
1. **Ingest context**:
   - Read relevant `claude-docs/docs/foundation.md`
   - Read relevant `claude-docs/docs/design/*.md`
   - Read relevant `claude-docs/docs/specs/*.md`
   - Read relevant `claude-docs/docs/policies/*.md`
...
- Database schema
- Design docs (`claude-docs/docs/design/*.md`)
- Spec docs (`claude-docs/docs/specs/*.md`) — you may NOT write or modify specs
...
- Read local files including:
  ...
  - Spec documents (`claude-docs/docs/specs/*.md`)
  - Design documents (`claude-docs/docs/design/*.md`)
  - Policy documents (`claude-docs/policies/*.md`)
...
- Relevant `claude-docs/docs/design/*.md`
- Relevant `claude-docs/docs/specs/*.md`
- Relevant `claude-docs/docs/policies/*.md`
...
```
claude-docs/reports/UAT/UAT-2025-11-28-v01.md
```

Second test the same day:
```
claude-docs/reports/UAT/UAT-2025-11-28-v02.md
```

First test the next day (resets):
```
claude-docs/reports/UAT/UAT-2025-11-29-v01.md
```
...
- Write or modify spec docs (`claude-docs/docs/specs/*.md`)
- Write or modify design docs (`claude-docs/docs/design/*.md`)
