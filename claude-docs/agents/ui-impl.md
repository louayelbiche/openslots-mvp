...
Plan:
  ...
  Files to Touch:
    - apps/web/src/... (create/update)
    - apps/web/src/... (update)
  Expected Outcome: [What will work when done]
```
...
- `claude-docs/docs/design/*.md` (design specifications)
- `claude-docs/docs/specs/*.md` (feature specifications)
- `claude-docs/docs/foundation.md` (UX principles)
- `claude-docs/policies/*.md` (coding policies)
...
- Documentation files in `claude-docs/docs/`
...
Inputs:
  - Design doc: claude-docs/docs/design/budget-selector.md
  - Spec doc: claude-docs/docs/specs/bidding.md
...
- Any tools outside standard file and build operations
