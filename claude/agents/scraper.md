...
```
claude/foundation.md           # Product principles (HIGHEST PRIORITY)
...
- `claude/docs/specs/*.md` (for data requirements)
...
# At end of scraping
tracker.flush()  # Writes to claude/reports/token-tracking/scraper/
```

### 7.3 Report Location

All usage reports are written to: `claude/reports/token-tracking/scraper/`
