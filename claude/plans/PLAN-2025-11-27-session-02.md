...
- **Directory Structure**: claude/history/, claude/policies/
...
### Policy Documents
- `claude/policies/planning.md` (create) - Centralized planning policy

### Agent Definitions
- `claude/agents/build-lead.md` (update) - Add mandatory planning section
- `claude/agents/ui-impl.md` (update) - Add planning requirements
- `claude/agents/api-impl.md` (update) - Add planning requirements
- `claude/agents/db-modeler.md` (update) - Add planning requirements
- `claude/agents/bidding-logic.md` (update) - Add planning requirements
- `claude/agents/slot-matcher.md` (update) - Add planning requirements
- `claude/agents/menu-parser.md` (update) - Add planning requirements
- `claude/agents/test-runner.md` (update) - Add planning requirements
- `claude/agents/doc-keeper.md` (update) - Add planning + session history management

### History & Plans
- `claude/history/2025-11-27/session-01.json` (create) - Retroactive session for discovery implementation
- `claude/history/2025-11-27/session-02.json` (create) - This implementation session
- `claude/plans/PLAN-2025-11-27-session-01.md` (create) - Detailed plan for session 01
- `claude/plans/PLAN-2025-11-27-session-02.md` (create) - This plan document

## 4. Implementation Sequence

### Step 1: Create Planning Policy Document
1. Create `claude/policies/planning.md` with:
...
3. Reference `claude/policies/planning.md` for complete requirements
...
5. Each subagent section includes:
   ...
   - Reference to `claude/policies/planning.md`
...
7. Create `claude/history/2025-11-27/session-01.json`
...
8. Create `claude/history/2025-11-27/session-02.json`
...
9. Create `claude/plans/PLAN-2025-11-27-session-01.md`
   - Detailed plan for discovery implementation
   - 8 phases from DB schema to commit
   - Success criteria and risk mitigation

10. Create `claude/plans/PLAN-2025-11-27-session-02.md`
...
11. Check all files exist and are properly formatted:
    - Policy file created at `claude/policies/planning.md`
...
- [x] `claude/policies/planning.md` created with complete policy
...
- MUST reference `claude/policies/planning.md`
...
- Reference `claude/policies/planning.md`
