...
| File | Date | Status |
|------|------|--------|
| `claude/history/2025-11-27/session-n.json` | 2025-11-27 | Legacy format |
| `claude/history/2025-11-27/session-01.json` | 2025-11-27 | Discovery flow implementation |
| `claude/history/2025-11-27/session-02.json` | 2025-11-27 | Planning policy implementation |
| `claude/history/2025-11-27/session-03.json` | 2025-11-27 | Full project audit |
| `claude/history/2025-11-27/session-04.json` | 2025-11-27 | Testing system setup |
| `claude/history/2025-11-28/session-01.json` | 2025-11-28 | Lovable prototype features |
...
### Agent Definition
- `claude/agents/usage-tracker.md` exists and is well-documented
...
claude/reports/UAT/UAT-2025-11-28-v002.md (UAT report)
claude/reports/UAT/UAT-2025-11-28-v003.md (UAT report)
```
