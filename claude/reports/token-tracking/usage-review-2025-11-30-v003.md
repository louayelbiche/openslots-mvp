...
- 6 documented sessions in `claude/history/`
...
Today (2025-11-30) has 4 commits but no session file. Create `claude/history/2025-11-30/session-01.json` before any further work.
